...
// Laboratorium : B1
// Deskripsi: membuat objek truk gandeng 3 dimensi dengan memanfaatkan depth dan lighting
//				pada OpenGL.
...
void TrukGandeng(){
	...
	glPushMatrix();
		...
		glBegin(GL_QUADS);
			...
			glVertex3f(3.25f, -1.0f, -0.43f);
			glVertex3f(0.75f, -1.0f, -0.43f);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glRotated(0, 0, 1, 0);
		glTranslatef(-10.0, 2.5, 2.01);
		glColor3f(0.0,0.3,0.0);
		glBegin(GL_QUADS);
			glVertex3f(1.25f, -1.5f, 0.0f);
			glVertex3f(-7.5f, -1.5f, 0.0f);
			glVertex3f(-7.5f, -1.2f, 0.0f);
			glVertex3f(1.25f, -1.2f, 0.0f);
		glEnd();
	glPopMatrix();
